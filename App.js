...
.then((responseJson) => {
            ...
            this.setState({
              forecast: {
                ...
                description: responseJson.weather[0].description,
                temp: responseJson.main.temp,
                KA: responseJson.wind.speed,
                MT: responseJson.sys.sunrise,
                MTb: responseJson.sys.sunset,
                tekanan: responseJson.main.pressure,
                kelembapan: responseJson.main.humidity,
                Tairlaut: responseJson.main.sea_level,
    ...
    <View style={styles.containerMain}>
      ...
      <View style={styles.boxOutput}>
        <View style={styles.boxOutput1}>
          ...
          <View style={styles.smallBoxOuput}>
            <Text style = {styles.textBox} >
            Kecepatan Angin : {this.state.forecast.KA}
            </Text>
          </View>
          <View style={styles.smallBoxOuput}>
            <Text style = {styles.textBox} >
            Matahari Terbit : {this.state.forecast.MT}
            </Text>
          </View>
          </View>
        <View style={styles.boxOutput1}>
          <View style={styles.smallBoxOuput}>
            <Text style = {styles.textBox} >
            Matahari Terbenam : {this.state.forecast.MTb}
            </Text>
          </View>
          <View style={styles.smallBoxOuput}>
            <Text style = {styles.textBox} >
            Tekanan Udara : {this.state.forecast.tekanan}
            </Text>
          </View>
          <View style={styles.smallBoxOuput}>
            <Text style = {styles.textBox} >
            Kelembapan Udara : {this.state.forecast.kelembapan}
            </Text>
          </View>
          <View style={styles.smallBoxOuput}>
            <Text style = {styles.textBox} >
            Tinggi Air Laut : {this.state.forecast.Tairlaut}
            </Text>
          </View>
          <View style={styles.smallBoxOuput}>
            <Text style = {styles.textBox} >
      ...
      <View style={styles.Footer}>
          <Text style={{ textAlign: 'right', padding: 18, fontSize: 14,color: 'white' }} >1515051073_Pebri Santosa</Text>
      </View>
